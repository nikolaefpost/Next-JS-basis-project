...
const ReviewForm: FC<ReviewFormProps> = ({
  ...
  return (
    <form onSubmit={handleSubmit(onHandleSubmit)}>
      <div className={cn(styles.review_form, className)} {...props}>
        <Input
          placeholder="Имя"
          error={errors.name}
          {...register('name', {
            required: { value: true, message: 'имя не заполнено' },
          })}
        ...
        />
        <div
          className={cn(styles.rate, { [styles.rate_error]: errors.rating })}
        >
          <span>Оценка:</span>
          <Controller
            name="rating"
      ...
      {isSuccess && (
        <div className={styles.success}>
          ...
          <p>
            Спасибо за отзыв. Перед публикацией отзыв пройдет предварительную
